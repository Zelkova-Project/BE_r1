package com.zelkova.zelkova.controller.message;
...
import com.zelkova.zelkova.dto.message.MessageDTO;
...
public class MessageController {
    ...
    public MessageController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSJQW44XBNNWOCY", "3AYN5OFXS89DD0EDQUO2OOSH2ACTUPAW", "https://api.coolsms.co.kr");
    }
    ...
    */
    ...
    public SingleMessageSentResponse sendMmsByResourcePath() throws IOException, java.io.IOException {
